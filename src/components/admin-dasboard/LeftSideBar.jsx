import { Calendar1, CoinsIcon, CreditCardIcon, File, Grid, HomeIcon, User2Icon, LogOut, X, UserCircle, BanknoteArrowUp, Ban } from "lucide-react"
...
const LeftSideBar = () => {
  ...
  const adminMenuItems = [
    ...
    { id: 'Repayments', label: 'Repayments', icon: BanknoteArrowUp },
