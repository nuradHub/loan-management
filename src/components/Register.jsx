...
const Register = ()=> {
  ...
  const {viewPassword, setViewPassword, isLoading, setIsLoading, fullname, setFullname, email, setEmail, password, setPassword, handleRegister} = useContext(AppContext)
    ...
    <div className="flex items-center justify-center h-screen w-full bg-white">
      <div className="w-full flex flex-col max-w-300 mx-auto gap-5 md:flex-row bg-white shadow shadow-slate-300">
        ...
        <div className="flex-1 w-full p-1 rounded-2xl bg-white md:p-5">
          <form className="flex flex-col gap-8 p-5" onSubmit={handleNewUser} method='POST'>
